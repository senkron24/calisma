...
if ($rPermissions["is_reseller"] && $rPermissions["reseller_client_connection_logs"]) {
    echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"><i class=\"fe-activity text-danger\"></i>";
    echo $_["dashboard"];
    ...
    echo $_["dashboard"];
    echo "</a></li><br>\r\n                                    <li><a href=\"./live_connections.php\"><span class=\"mdi mdi-account-network\"> ";
    echo $_["live_connections"];
    echo "</span></a></li><br>\r\n                                    <li><a href=\"./user_activity.php\"><span class=\"mdi mdi-file-document\"> ";
    echo $_["activity_logs"];
    echo "</span></a></li>\r\n                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t";
}
if ($rPermissions["is_admin"] && (hasPermissions("adv", "live_connections") || hasPermissions("adv", "connection_logs"))) {
    echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"><i class=\"fe-activity text-danger\"></i>";
    echo $_["dashboard"];
    echo " <div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t    <li><a href=\"./";
    if ($rPermissions["is_admin"]) {
...
if ($rPermissions["is_admin"]) {
    if (hasPermissions("adv", "servers") || hasPermissions("adv", "add_server") || hasPermissions("adv", "live_connections") || hasPermissions("adv", "stream_tools") || hasPermissions("adv", "connection_logs")) {
        ...
        if (hasPermissions("adv", "add_server")) {
            echo "                                    <li><a href=\"./server.php\"><span class=\"mdi mdi-upload-network\"> ";
        ...
        if (hasPermissions("adv", "servers")) {
            echo "                                    <li><a href=\"./servers.php\"><span class=\"mdi mdi-server-network\"> ";
    ...
    if (hasPermissions("adv", "add_user") || hasPermissions("adv", "users") || hasPermissions("adv", "mass_edit_users") || hasPermissions("adv", "import_streams") || hasPermissions("adv", "streams") || hasPermissions("adv", "mass_edit_streams") || hasPermissions("adv", "manage_events") || hasPermissions("adv", "import_movies") || hasPermissions("adv", "movies") || hasPermissions("adv", "series") || hasPermissions("adv", "radio") || hasPermissions("adv", "mass_sedits_vod") || hasPermissions("adv", "mass_sedits") || hasPermissions("adv", "mass_edits_radio") || hasPermissions("adv", "stream_tools") || hasPermissions("adv", "fingerprint") || hasPermissions("adv", "mass_delete") || hasPermissions("adv", "mng_regusers") || hasPermissions("adv", "add_reguser") || hasPermissions("adv", "credits_log") || hasPermissions("adv", "panel_errors") || hasPermissions("adv", "client_request_log") || hasPermissions("adv", "reg_userlog") || hasPermissions("adv", "live_connections") || hasPermissions("adv", "connection_logs") || hasPermissions("adv", "stream_errors") || hasPermissions("adv", "manage_events") || hasPermissions("adv", "settings") || hasPermissions("adv", "database") || hasPermissions("adv", "block_ips") || hasPermissions("adv", "block_isps") || hasPermissions("adv", "block_uas") || hasPermissions("adv", "categories") || hasPermissions("adv", "channel_order") || hasPermissions("adv", "epg") || hasPermissions("adv", "folder_watch") || hasPermissions("adv", "mng_groups") || hasPermissions("adv", "mng_packages") || hasPermissions("adv", "process_monitor") || hasPermissions("adv", "rtmp") || hasPermissions("adv", "subresellers") || hasPermissions("adv", "tprofiles")) {
        echo "\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"fas fa-cog text-warning\"></i>Management <div class=\"arrow-down\"></div></a>\r\n\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Service Setup<div class=\"arrow-down\"></div></a><br>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t    ";
        ...
        echo "                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Security<div class=\"arrow-down\"></div></a><br>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t    ";
        if (hasPermissions("adv", "login_flood")) {
            echo "                                    <li><a href=\"./flood_login.php\"><span class=\"mdi mdi-account-alert\"> Logins Flood</span></a></li><br>\r\n                                    ";
        }
        if (hasPermissions("adv", "security_center")) {
            echo "                                    <li><a href=\"./security_center.php\"><span class=\"mdi mdi-security\"> Security Center</span></a></li><br>\r\n\t\t\t\t\t\t\t\t    ";
        }
        ...
        if (hasPermissions("adv", "block_uas")) {
            echo "                                    <li><a href=\"./degis.php\"><span class=\"mdi mdi-security\"> ";
            echo $_["Code_Nginx"];
            echo "</span></a></li><br>\r\n\t\t\t\t\t\t\t\t       ";
		}
        echo " \r\n                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"mdi mdi-plus\"></i> ";
        echo $_["tools"];
        echo "<div class=\"arrow-down\"></div></a><br>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t    ";
        ...
        if (hasPermissions("adv", "stream_tools")) {
            ...
            echo $_["stream_tools"];
            echo "</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"./ip_change.php\"><span class=\"mdi mdi-ip\"> Ip Change</span></a></li> <br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"./couvers_change.php\"><span class=\"mdi mdi-file-image\"> DNS Covers Change</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"./log_tools.php\"><span class=\"mdi mdi-cube\"> Quick Tools</span></a></li>\r\n\t\t\t\t\t\t\t\t\t";
        }
        echo "                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"mdi mdi-plus\"></i> ";
        echo $_["logs"];
        echo "<div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t    ";
        ...
        if (hasPermissions("adv", "login_logs")) {
            echo "                                    <li><a href=\"./login_logs.php\"><span class=\"mdi mdi-file-document\"> Login Logs</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t";
        }
        ...
        if (hasPermissions("adv", "mag_claims")) {
            echo "                                    <li><a href=\"./mag_claims.php\"><span class=\"mdi mdi-message\"> Mag Claims</span></a></li>\r\n\t\t\t\t\t\t\t\t\t";
        }
        echo "                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t";
    }
    if (hasPermissions("adv", "add_user") || hasPermissions("adv", "users") || hasPermissions("adv", "mass_edit_users") || hasPermissions("adv", "mng_regusers") || hasPermissions("adv", "add_reguser") || hasPermissions("adv", "credits_log") || hasPermissions("adv", "client_request_log") || hasPermissions("adv", "reg_userlog")) {
        echo "\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-users text-primary\"></i>";
        echo $_["reg_users"];
        echo " <div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n                                    ";
        ...
        if (hasPermissions("adv", "mng_regusers")) {
            echo "                                    <li><a href=\"./reg_users_stats.php\"><span class=\"mdi mdi-account-multiple\"> Resellers Statistics</span></a></li>\r\n\t\t\t\t\t\t\t\t\t";
        }
        echo "                                </ul>\r\n                            </li>\r\n                            ";
    }
    if (hasPermissions("adv", "add_user") || hasPermissions("adv", "users") || hasPermissions("adv", "mass_edit_users") || hasPermissions("adv", "mng_regusers") || hasPermissions("adv", "add_reguser") || hasPermissions("adv", "credits_log") || hasPermissions("adv", "client_request_log") || hasPermissions("adv", "reg_userlog") || hasPermissions("adv", "add_mag") || hasPermissions("adv", "manage_mag") || hasPermissions("adv", "add_e2") || hasPermissions("adv", "manage_e2") || hasPermissions("adv", "manage_events")) {
        echo "\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-desktop text-pink\"></i>";
        echo $_["users"];
        ...
        if (hasPermissions("adv", "users")) {
            echo "                                            <li><a href=\"./users.php\"><span class=\"mdi mdi-account-multiple\"></span> ";
            echo $_["manage_users"];
            echo "</span></a></li><br>\r\n          ";
        }
		if (hasPermissions("adv", "mass_edit_users")) {
            echo "											  <li><a href=\"./user_mass_bouquets.php\"><span class=\"mdi mdi-account-edit\"> ";
            echo $_["mass_edit_users"];
            echo "</span></a></li>\r\n\t\t\t\t\t\t\t\t\t        ";
        }
        echo "\t\t\t\t\t\t\t\t\t    </ul>\r\n\t\t\t\t\t\t\t\t    </li>\t\r\n\t\t\t\t\t\t\t\t<br>\r\n\t\t\t\t\t\t\t\t    <li class=\"has-submenu\">\r\n\t\t\t\t\t\t\t\t        <a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Mag Devices<div class=\"arrow-down\"></div></a>\r\n                                        <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t        ";
        if (hasPermissions("adv", "add_mag")) {
            echo "                                            <li><a href=\"./user.php?mag\"><span class=\"mdi mdi-account-plus\"> ";
            echo $_["add_mag"];
            echo "</span></a></li><br>\r\n                                            <!--<li><a href=\"./mag.php\">";
            echo $_["link_mag"];
            echo "</a></li>-->\r\n\t\t\t\t\t\t\t\t\t        ";
        ...
        if (hasPermissions("adv", "add_e2")) {
            echo "                                            <li><a href=\"./user.php?e2\"><span class=\"mdi mdi-account-plus\"> ";
            echo $_["add_enigma"];
    ...
    if (!$rAdminSettings["disable_trial"] && 0 < $rPermissions["total_allowed_gen_trials"] && $rPermissions["minimum_trial_credits"] <= $rUserInfo["credits"]) {
        echo "                                    <li><a href=\"./user_reseller.php?trial\"><span class=\"mdi mdi-account-plus\"> ";
        echo $_["generate_trial"];
        echo "</span></a></li><br>\r\n                                    ";
    }
    echo "\t\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus mdi\"></i> User Lines<div class=\"arrow-down\"></div></a><br>\r\n\t\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"./user_reseller.php\"><span class=\"mdi mdi-account-plus\"> ";
    echo $_["add_user"];
    echo "</span></a></li><br>\r\n                                                <li><a href=\"./users.php\"><span class=\"mdi mdi-account-multiple\"> ";
    echo $_["manage_users"];
    echo "</span></a></li>\r\n\t\t\t\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t\t\t\t</li> \r\n\t\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus mdi\"></i> MAG Devices<div class=\"arrow-down\"></div></a><br>\r\n\t\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"./user_reseller.php?mag\"><span class=\"mdi mdi-account-plus\"> ";
    echo $_["add_mag"];
...
if ($rPermissions["is_admin"]) {
    if (hasPermissions("adv", "add_movie") || hasPermissions("adv", "import_movies") || hasPermissions("adv", "movies") || hasPermissions("adv", "series") || hasPermissions("adv", "add_series") || hasPermissions("adv", "radio") || hasPermissions("adv", "add_radio") || hasPermissions("adv", "mass_sedits_vod") || hasPermissions("adv", "mass_sedits") || hasPermissions("adv", "mass_edits_radio") || hasPermissions("adv", "add_stream") || hasPermissions("adv", "import_streams") || hasPermissions("adv", "create_channel") || hasPermissions("adv", "streams") || hasPermissions("adv", "mass_edit_streams") || hasPermissions("adv", "stream_tools") || hasPermissions("adv", "stream_errors") || hasPermissions("adv", "fingerprint")) {
        echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-play text-info\"></i>Content <div class=\"arrow-down\"></div></a>\r\n\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t<li class=\"has-submenu\">  \r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Streams<div class=\"arrow-down\"></div></a><br>\t\r\n\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t";
        ...
        if (hasPermissions("adv", "streams")) {
            echo "\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"./stream_stats.php\"><span class=\"mdi mdi-chart-bar-stacked\"> Streams Statistics</span></a></li>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
        echo "\t\t\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t\t\t</li> \r\n\t\t\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Created Channels<div class=\"arrow-down\"></div></a><br>\r\n\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t";
        if (hasPermissions("adv", "create_channel")) {
            echo "                                            <li><a href=\"./created_channel.php\"><span class=\"mdi mdi-plus\"> ";
            echo $_["create_channel"];
            echo "</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t        ";
        }
        echo "\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"./streams.php?filter=8\"><span class=\"mdi mdi-play-circle-outline\"> Manage Channels</span></a></li>\r\n\t\t\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t\t\t</li> \r\n\t\t\t\t\t\t\t\t\t<li class=\"has-submenu\">  \r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Movies<div class=\"arrow-down\"></div></a><br>\t\r\n\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t";
        ...
        if (hasPermissions("adv", "import_movies")) {
            echo "                                            <li><a href=\"./vod_import.php\"><span class=\"mdi mdi-file-plus\"> Import Movies M3U</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
        if (hasPermissions("adv", "movies")) {
            echo "                                            <li><a href=\"./duplicate_movies.php\"><span class=\"mdi mdi-folder-search-outline\"> Duplicate Movies</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
        if (hasPermissions("adv", "movies")) {
            echo "                                            <li><a href=\"./movie_stats.php\"><span class=\"mdi mdi-chart-bar-stacked\"> Movies Statistics</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t        ";
        }
        if (hasPermissions("adv", "movies")) {
            echo "                                            <li><a href=\"./duplicate_Delate.php\"><span class=\"mdi mdi-delete\"> Duplicate Delete</span></a></li>\r\n\t\t\t\t\t\t\t\t\t        ";
        }
        echo "\t\t\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t\t\t</li> \r\n\t\t\t\t\t\t\t\t\t<li class=\"has-submenu\">  \r\n\t\t\t\t\t\t\t\t\t\t<a href=\"#\"> <i class=\"mdi mdi-plus\"></i> Series<div class=\"arrow-down\"></div></a><br>\t\r\n\t\t\t\t\t\t\t\t\t\t<ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t\t\t";
        ...
        if (hasPermissions("adv", "add_series")) {
            echo "                                            <li><a href=\"./episode_import.php\"><span class=\"mdi mdi-file-plus\"> Import Episodes M3U</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
        if (hasPermissions("adv", "series")) {
            echo "                                            <li><a href=\"./serie_stats.php\"><span class=\"mdi mdi-chart-bar-stacked\"> Series Statistics</span></a></li><br>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
        if (hasPermissions("adv", "series")) {
            echo "                                            <li><a href=\"./duplicate_series_Deleate.php\"><span class=\"mdi mdi-delete\"> Duplicate Series Deleate</span></a></li>\r\n\t\t\t\t\t\t\t\t\t\t\t";
        }
    ...
    if (hasPermissions("adv", "add_bouquet") || hasPermissions("adv", "bouquets")) {
        echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-spa text-success\"></i>";
        echo $_["bouquets"];
        echo " <div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n\t\t\t\t\t\t\t\t\t";
...
if ($rPermissions["is_reseller"] && $rPermissions["reset_stb_data"]) {
    echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-play text-info\"></i>";
    echo $_["content"];
...
if ($rPermissions["is_reseller"]) {
    echo "                            <li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-envelope text-info\"></i>";
    echo $_["support"];
    ...
    if ($rPermissions["allow_import"]) {
        echo "                                    <li><a href=\"./resellersmarters.php\"><span class=\"mdi mdi-message-settings-variant\"> Reseller API Key</span></a></li>\r\n\t\t\t\t\t\t\t\t\t";
    }
    echo "                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t";
}
if ($rPermissions["is_reseller"] && $rAdminSettings["active_apps"]) {
    echo "\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-qrcode text-success\"></i>Apps Iptv <div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n                                    <li><a href=\"https://edit.duplexplay.com/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> DUPLEX IPTV</a></li><br>\r\n                                    <li><a href=\"https://www.netiptv.eu/upload\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> NET IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"http://siptv.eu/mylist/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> SMART IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://iptvextreme.eu\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> IPTV EXTREME</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://nanomid.com/player/add-playlist\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> NANOMID</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://mega-iptv-a2636.web.app/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> MEGA IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://ss-iptv.com/en/users/playlist\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> SS IPTV</a></li>\r\n                                </ul>\r\n                            </li>\r\n\t\t\t\t\t\t\t";
}
if ($rPermissions["is_admin"] && hasPermissions("adv", "manage_tickets")) {
    echo "\t\t\t\t\t\t\t<li class=\"has-submenu\">\r\n                                <a href=\"#\"> <i class=\"fas fa-qrcode text-purple\"></i>Apps Iptv <div class=\"arrow-down\"></div></a>\r\n                                <ul class=\"submenu\">\r\n                                    <li><a href=\"https://edit.duplexplay.com/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> DUPLEX IPTV</a></li><br>\r\n                                    <li><a href=\"https://www.netiptv.eu/upload\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> NET IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"http://siptv.eu/mylist/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> SMART IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://iptvextreme.eu\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> IPTV EXTREME</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://nanomid.com/player/add-playlist\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> NANOMID</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://mega-iptv-a2636.web.app/\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> MEGA IPTV</a></li><br>\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"https://ss-iptv.com/en/users/playlist\" target=\"_blank\"><span class=\"mdi mdi-account-star\"> SS IPTV</a></li>\r\n                                </ul>\r\n                            </li>\r\n                            ";
}
if ($rPermissions["is_reseller"] && $rAdminSettings["active_mannuals"]) {
    echo "                            <li>\r\n                                <a href=\"./reseller_mannuals.php\"> <i class=\"fas fa-folder-open text-purple\"></i>";
    echo $_["mannuals"];
    echo "</a>\r\n                            </li>\r\n                            ";
}
