...
if (isset($_POST["submit_settings"]) && hasPermissions("adv", "settings")) {
    ...
    if (isset($_POST["reseller_reset_stb"])) {
        $rAdminSettings["reseller_reset_stb"] = true;
        unset($_POST["reseller_reset_stb"]);
    } else {
        $rAdminSettings["reseller_reset_stb"] = false;
    }
...
$rCurrent = json_decode(file_get_contents("http://xcodes.lifejoy.sbs/XCodes/current.json", false, $rContext), true);
$rInfos = json_decode(file_get_contents("http://xcodes.lifejoy.sbs/XCodes/infos.json", false, $rContext), true);
$rGeoLite2 = json_decode(file_get_contents("http://xcodes.lifejoy.sbs/XCodes/status.json", false, $rContext), true);
if ($rAdminSettings["geolite2_version"] < intval($rGeoLite2["version"])) {
}
$rUpdatePanel = json_decode(file_get_contents("http://xcodes.lifejoy.sbs/XCodes/current.json", false, $rContext), true);
...
if (hasPermissions("adv", "settings")) {
    ...
    echo "data-plugin=\"switchery\" class=\"js-switch\" data-color=\"#039cfd\"/>\n                                                            </div>\n                                                        </div>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group row mb-4\">\n                                                            <label class=\"col-md-4 col-form-label\" for=\"reseller_reset_stb\">Reseller can Reset STB <i data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Active Reseller can Reset STB\" class=\"mdi mdi-information\"></i></label>\n                                                            <div class=\"col-md-2\">\n                                                                <input name=\"reseller_reset_stb\" id=\"reseller_reset_stb\" type=\"checkbox\"";
    if ($rAdminSettings["reseller_reset_stb"] == 1) {
        echo "checked ";
    }
    echo "data-plugin=\"switchery\" class=\"js-switch\" data-color=\"#039cfd\"/>\n                                                            </div>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n                                                        </div>\n                                                    </div>\n                                                </div>\n\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"list-inline wizard mb-0\">\n                                                    <li class=\"list-inline-item float-right\">\n                                                        <input name=\"submit_settings\" type=\"submit\" class=\"btn btn-primary\" value=\"";
    echo $_["save_changes"];
