...
echo "') == false) {\r\n                    return;\r\n                }\r\n                \$(\".bs-logs-modal-center\").modal(\"hide\");\r\n                \$.getJSON(\"./api.php?action=clear_logs&type=login_users&from=\" + encodeURIComponent(\$(\"#range_clear_from\").val()) + \"&to=\" + encodeURIComponent(\$(\"#range_clear_to\").val()), function(data) {\r\n                    \$.toast(\"Logs have been cleared.\");\r\n                    \$(\"#datatable-activity\").DataTable().ajax.reload( null, false );\r\n                });\r\n            });\r\n            \$(\"#datatable-activity\").DataTable({\r\n                language: {\r\n                    paginate: {\r\n                        previous: \"<i class='mdi mdi-chevron-left'>\",\r\n                        next: \"<i class='mdi mdi-chevron-right'>\"\r\n                    },\r\n                    infoFiltered: \"\"\r\n                },\r\n                drawCallback: function() {\r\n                    \$(\".dataTables_paginate > .pagination\").addClass(\"pagination\");\r\n                    \$('[data-toggle=\"tooltip\"]').tooltip();\r\n                },\r\n                responsive: false,\r\n                processing: true,\r\n                serverSide: true,\r\n                ajax: {\r\n                    url: \"./table_search.php\",\r\n                    \"data\": function(d) {\r\n                        d.id = \"login_user_logs\",\r\n                        d.range = getRange(),\r\n                        d.reseller = getReseller()\r\n                    }\r\n                },\r\n                columnDefs: [\r\n                    {\"className\": \"dt-center\", \"targets\": [0,5]},\r\n\t\t\t\t\t{\"orderable\": false, \"targets\": [5]},\r\n                    {\"visible\": false, \"targets\": []}\r\n                ],\r\n                \"order\": [[ 0, \"desc\" ]],\r\n                pageLength: ";
