...
// notes user check ok
                ...
                if ($rPermissions["is_admin"]) {
                    $rButtons .= "<button type=\"button\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Extend line\" class=\"btn btn-dark waves-effect waves-light btn-xs\" onClick=\"renew_user('" . $rRow["id"] . "', '" . $rRow["username"] . "');\"><i class=\"mdi mdi-autorenew mdi-spin\"></i></button>\r\n                         ";
                }
                if ($rPermissions["is_admin"]) {
                ...
                if (!empty($row2["stream_display_name"])) {
                    ...
                    $rStream_name = "<span style='color: #20a009;'>" . $row2["stream_display_name"] . " - ( <span style='color: #737373;'>" . $row2["container"] . " )</span>" . "<br><span style='color: #737373;'>Uptime </span>" . "<span style='color: #737373;'>" . sprintf("%02d:%02d:%02d", $rTime / 3600, $rTime / 60 % 60, $rTime % 60) . "</span><br><a target='_blank' href='https://www.ip-tracker.org/locator/ip-lookup.php?ip=" . $row2["user_ip"] . "'>" . $row2["user_ip"] . "</a> <img src='http://51.75.53.120/XCodes/flags/svg/" . strtolower($row2["geoip_country_code"]) . ".svg' width='16' height='12' alt='Ülke bayrağı'>" . "<br><span style='color: #737373;'>" . $rRow["isp_desc"] . "</span>";
                } else {
                    $rStream_name = "-";
                }
                if ($rPermissions["is_admin"]) {
...
// notes mag CHECK OK
                if ($rPermissions["is_admin"] && hasPermissions("adv", "edit_mag") || $rPermissions["is_reseller"] && $rAdminSettings["reseller_reset_stb"]) {
                    $rButtons .= "<button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Reset STB\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\" onClick=\"api(" . $rRow["id"] . ", 'reset_stb');\"><i class=\"mdi mdi-chemical-weapon\"></i></button>";
                }
                if ($rPermissions["is_admin"] && hasPermissions("adv", "edit_user") || $rPermissions["is_reseller"] && $rAdminSettings["reseller_reset_isplock"]) {
                    $rButtons .= "<button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Reset isp\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\" onClick=\"api(" . $rRow["id"] . ", 'resetispuser');\"><i class=\"mdi mdi-lock-reset\"></i></button>";
                }
                ...
                if ($rPermissions["is_admin"] && hasPermissions("adv", "edit_mag") || $rPermissions["is_reseller"] && $rAdminSettings["reseller_mag_to_m3u"]) {
                    $rButtons .= "<button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Convert MAG to M3U\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\" onClick=\"api(" . $rRow["id"] . ", 'magtouser');\"><i class=\"mdi mdi-account-convert\"></i></button>";
                }
                if ($rPermissions["is_reseller"] && $rPermissions["delete_users"] || $rPermissions["is_admin"] && hasPermissions("adv", "edit_user")) {
                    $rButtons .= "<a href=\"./user_stats.php?user_id=" . $rRow["id"] . "\"><button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"User Stats\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\"><i class=\"mdi mdi-chart-bar-stacked\"></i></button></a>";
                }
    ...
    if (0 < $rReturn["recordsTotal"]) {
        ...
        if ($rResult && 0 < $rResult->num_rows) {
            while ($rRow = $rResult->fetch_assoc()) {
                ...
                if ($rPermissions["is_admin"]) {
                    if (hasPermissions("adv", "edit_reguser")) {
                        $rButtons .= "<a href=\"./reg_user.php?id=" . $rRow["id"] . "\"><button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Edit\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\"><i class=\"mdi mdi-pencil\"></i></button></a>\r\n\t\t\t\t\t\t";
                    ...
                    $rButtons .= "<a href=\"./subreseller.php?id=" . $rRow["id"] . "\"><button data-toggle=\"tooltip\" data-placement=\"top\" title=\"\" data-original-title=\"Edit\" type=\"button\" class=\"btn btn-dark waves-effect waves-light btn-xs\"><i class=\"mdi mdi-pencil\"></i></button></a>";
                }
